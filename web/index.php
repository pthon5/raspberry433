...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/">Live update</a>
                </li>
                <li class="nav-item">
...
<h5>Update Interval: 2sec.</h5>
<form id="maxForm" class="col-md-1">
    <div class="form-group col-sm">
        <label for="exampleFormControlSelect1" class="col-form-label-lg">Max </label>
        <select class="form-control col-sm" id="exampleFormControlSelect1" name="max">
            <option>5</option>
            <option>10</option>
            <option>30</option>
            <option>50</option>
